        ...
        <div class="container-fluid">
            ...
            <div class="row" id="main" >
                ...
                require('open-connection.php');
                    $strsql = "SELECT * FROM products_table WHERE id = " . $_SESSION['k'];
                    if($rsPro = mysqli_query($con, $strsql)){
                        if(mysqli_num_rows($rsPro)>0){
                            $resPro = mysqli_fetch_array($rsPro);
                            mysqli_free_result($rsPro);
                        }
                    }
                        ...
                        if(isset($_FILES['picture_photo1'])){
                            ...
                            if(isset($_FILES['picture_photo2'])){
                                ...
                                if(empty($arrERRORphoto2)){
                                    ...
                                    $strsql = "UPDATE products_table set name = '$product_name', description = '$product_description', price='$product_prices',photo1='$photo1', photo2='$photo2' WHERE id = ". $_SESSION['k'];
                ...
                <form method="post" enctype="multipart/form-data">
                    <div class="col-sm-5 my-1 ">
                        ...
                        <button type="submit" class="btn btn-primary mt-2 w-100 " name="btnUpdate" style="float: right;">Update Product</button>
                        <hr>
                    </div>
                </form>
            </div>
